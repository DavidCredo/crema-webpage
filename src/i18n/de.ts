export default {
  // Meta / global
  "site.title": "Crema — Dein Espresso-Tracker",
  "site.description": "Tracke deinen Espresso. Verfeinere dein Handwerk.",
  ...
  // Footer
  "footer.tagline": "Mit Liebe und (viel) Koffein gemacht",
  ...
  "features.subheading":
    "Kein weiterer generischer Tracker. Crema ist so designt, wie du tatsächlich brühst.",
  "features.shot.title": "Shot-first Logging",
  "features.shot.description":
    "Einfach loslegen. Crema füllt smarte Standardwerte deines letzten Shots mit derselben Bohne vor. Dosis, Yield und Zeit in Sekunden loggen.",
  "features.beans.title": "Bohnen-Bibliothek",
  "features.beans.description":
    "Führe einen lebendigen Katalog jeder Packung. Röster, Herkunft, Geschmacksnoten, Röstdatum — alles verknüpft mit deiner Brew-History.",
  "features.dial.title": "Einwählen, kein Rätselraten mehr",
  "features.dial.description.before": "Sieh, wie sich Mahlgrad, Dosis und Ratio über die Zeit entwickeln. Den ",
  "features.dial.description.emphasis": "goldenen Shot",
  "features.dial.description.after":
    " gefunden? Speicher das Rezept als Favorit. Wenn du den Kaffee das nächste Mal kaufst, öffne Crema und leg los!",

  // Landing – Privacy callout
  ...
  "support.faq.delete.q": "Was passiert, wenn ich die App lösche?",
  "support.faq.delete.a":
    "Da alle Daten lokal gespeichert werden, löscht das Entfernen von Crema deine Brew-History und Bohnen-Bibliothek dauerhaft. Eine Wiederherstellung ist nicht möglich.",
  "support.faq.free.q": "Ist Crema kostenlos?",
  "support.faq.free.a":
    "Crema wird mit einer kostenlosen Stufe starten. Einige Features werden möglicherweise als Einmalkauf verfügbar sein — keine Abos.",
  "support.faq.bug.q": "Ich habe einen Bug gefunden. Was soll ich tun?",
  "support.faq.bug.a_prefix": "Schreib mir an ",
  "support.faq.bug.a_suffix":
    " mit einer Beschreibung des Problems und deiner Geräte-/iOS-Version. Screenshots helfen sehr.",

  // Privacy page
  "privacy.title": "Datenschutzerklärung — Crema",
  ...
  "privacy.website.text":
    "Diese Website wird auf einem Server in Deutschland selbst gehostet. Wenn du die Seite besuchst, protokolliert unser Webserver automatisch bestimmte technische Daten für Sicherheits- und Betriebszwecke. Dazu gehören:",
  "privacy.website.list.ip":
    "Eine gekürzte Version deiner IP-Adresse (der letzte Teil wird maskiert, sodass deine vollständige Adresse nie gespeichert wird)",
  "privacy.website.list.date": "Datum und Uhrzeit der Anfrage",
  "privacy.website.list.page": "Die angeforderte Seite oder Ressource",
  "privacy.website.list.ua": "Der User-Agent-String deines Browsers",
  "privacy.website.list.referrer": "Die verweisende URL (falls vorhanden)",
  "privacy.website.list.status": "HTTP-Statuscode und Antwortgröße",
  ...
  "privacy.analytics.text":
    ", einen datenschutzfreundlichen Analytik-Dienst, um die Nutzung von Crema aggregiert zu verstehen. TelemetryDeck wurde von Grund auf mit Datenschutz im Sinn entwickelt.",
  "privacy.analytics.list_intro": "Die erhobenen Daten umfassen:",
  "privacy.analytics.list.id":
    "Eine anonymisierte Nutzer-ID, die nicht auf dich persönlich zurückgeführt werden kann",
  "privacy.analytics.list.events":
    'Grundlegende Nutzungsereignisse, die von uns definiert werden (z.B. „App gestartet", „Shot geloggt")',
  "privacy.analytics.list.time":
    "Ein auf die nächste Stunde gerundeter Zeitstempel",
  "privacy.analytics.list.device":
    "Gerätemetadaten wie iOS-Version, App-Version und Gerätetyp",
  "privacy.analytics.no_pii":
    "TelemetryDeck erhebt keine personenbezogenen Daten, trackt dich nicht über Apps oder Websites hinweg und verwendet keine Cookies. Alle Nutzer-IDs werden vor dem Versand kryptografisch gehasht und auf TelemetryDecks Servern zusätzlich gesalzen. Das TelemetryDeck SDK ist ",
  "privacy.analytics.opensource": "vollständig Open Source",
  "privacy.analytics.location":
    "TelemetryDeck GmbH hat ihren Sitz in Augsburg, Deutschland, und verarbeitet Daten auf Servern in der Europäischen Union. Weitere Details findest du in ",
  "privacy.analytics.td_policy": "TelemetryDecks eigener Datenschutzerklärung",
  ...
  "privacy.retention.text2_link":
    "TelemetryDecks Richtlinie zur Datenspeicherung",
  "privacy.retention.text2_suffix":
    " aufbewahrt. Da die Daten anonymisiert und kryptografisch gehasht sind, können sie nicht mit einzelnen Nutzern verknüpft werden.",
  ...
  "imprint.provider": "Diensteanbieter",
  "imprint.contact": "Kontaktmöglichkeiten",
