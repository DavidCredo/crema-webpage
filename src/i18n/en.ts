export default {
  // Meta / global
  "site.title": "Crema — Track Your Espresso",
  "site.description": "Track your espresso. Refine your craft.",
  ...
  // Footer
  "footer.tagline": "Made with love and (lots) of caffeine",
  "footer.copyright": `© ${new Date().getFullYear()} David Credo. All rights reserved.`,

  // Landing – Hero
  "hero.badge": "Now available on the App Store",
  "hero.title.line1": "Every shot",
  "hero.title.line2": "tells a story.",
  "hero.subtitle":
    "Crema helps you log espresso shots, manage your bean library, and dial in your perfect brew — one pull at a time.",
  "hero.cta": "Download on the App Store",

  // Landing – Features
  "features.heading": "Built for the ritual.",
  "features.subheading":
    "Not another generic tracker. Crema is designed around how you actually brew.",
  "features.shot.title": "Shot-first logging",
  "features.shot.description":
    "Start pulling. Crema pre-fills smart defaults from your last shot with the same bean. Log dose, yield, and time in seconds.",
  "features.beans.title": "Bean library",
  "features.beans.description":
    "Keep a living catalog of every bag. Roaster, origin, tasting notes, roast date — all linked to your brew history.",
  "features.dial.title": "Dial it in, no more guess work",
  "features.dial.description.before": "See how your grind, dose, and ratio evolve over time. Found that ",
  "features.dial.description.emphasis": "golden shot",
  "features.dial.description.after":
    "? Favorite the recipe. The next time you buy that coffee again, open up Crema and get brewing!",
  ...
  // Landing – Notify
  "notify.heading": "Get Crema.",
  "notify.text":
    "Track your espresso shots, build your bean library, and dial in your perfect brew. Available now on the App Store.",
  "notify.cta": "Download on the App Store",

  // Support page
  "support.title": "Support — Crema",
  "support.heading": "Support",
  "support.intro":
    "Crema is built by one person. If something's off, I want to hear about it.",
  "support.contact.heading": "Get in touch",
  "support.contact.text":
    "For bug reports, feature requests, or general questions, email me directly:",
  ...
  "support.faq.delete.q": "What happens if I delete the app?",
  "support.faq.delete.a":
    "Since all data is stored locally, deleting Crema permanently removes your brew history and bean library. There's no way to recover it.",
  "support.faq.free.q": "Is Crema free?",
  "support.faq.free.a":
    "Crema will launch with a free tier. Some features may be available as a one-time purchase — no subscriptions.",
  "support.faq.bug.q": "I found a bug. What should I do?",
  "support.faq.bug.a_prefix": "Email me at ",
  "support.faq.bug.a_suffix":
    " with what happened and your device/iOS version. Screenshots help a lot.",

  // Privacy page
  "privacy.title": "Privacy Policy — Crema",
  ...
  "privacy.website.list.page": "The page or resource requested",
  "privacy.website.list.ua": "Your browser's user agent string",
  ...
  "privacy.analytics.text":
    ", a privacy-friendly analytics service, to understand how Crema is used in aggregate. TelemetryDeck was designed from the ground up with privacy in mind.",
  "privacy.analytics.list_intro": "The data collected includes:",
  ...
  "privacy.analytics.no_pii":
    "TelemetryDeck does not collect personally identifiable information, does not track you across apps or websites, and does not use cookies. All user identifiers are cryptographically hashed before being sent, and further salted on TelemetryDeck's servers. The TelemetryDeck SDK is ",
  "privacy.analytics.opensource": "fully open source",
  "privacy.analytics.location":
    "TelemetryDeck GmbH is based in Augsburg, Germany, and processes data on servers located in the European Union. For more details, see ",
  "privacy.analytics.td_policy": "TelemetryDeck's own privacy policy",
  ...
  "privacy.retention.text2_suffix":
    ". Because the data is anonymized and cryptographically hashed, it cannot be linked back to individual users.",
  ...
  "privacy.contact.text_prefix":
    "Questions about this policy or how Crema handles your data? Reach out at ",

  // Imprint page
  "imprint.title": "Imprint — Crema",
  "imprint.heading": "Imprint",
  "imprint.provider": "Service provider",
